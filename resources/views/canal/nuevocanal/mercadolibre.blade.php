            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mercadolibre</h4>
                        <p class="card-title-desc">Vincula con tu cuenta de mercadolibre</p>
                    </div><!-- end card header -->
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-xl-12">
                                <h5 class="font-size-15 mb-3">Serás redirigido a Mercadolibre para confirmar la vinculación del catálogo.</h5>
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="{{ route('auth.mercadolibre') }}" class="btn btn-primary waves-effect btn-label waves-light"><i
